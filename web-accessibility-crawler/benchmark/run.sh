...
RESULT_FILE="$RESULTS_DIR/web-accessibility-crawler_$(date +%Y%m%d_%H%M%S).txt"
...
echo "╔══════════════════════════════════════════╗"
echo "║       Web Accessibility Crawler Bench    ║"
echo "╚══════════════════════════════════════════╝"
...
build_image "wac-go" "$PROJECT_DIR/go"
build_image "wac-rust" "$PROJECT_DIR/rust"
build_image "wac-zig" "$PROJECT_DIR/zig"
echo ""
...
run_benchmark "Go" "wac-go"
run_benchmark "Rust" "wac-rust"
run_benchmark "Zig" "wac-zig"
...
echo "── Binary Size ───────────────────────────────"
printf "  Go  : %s\n" "$(get_binary_size wac-go /usr/local/bin/web-accessibility-crawler)"
printf "  Rust: %s\n" "$(get_binary_size wac-rust /usr/local/bin/web-accessibility-crawler)"
printf "  Zig : %s\n" "$(get_binary_size wac-zig /usr/local/bin/web-accessibility-crawler)"
echo ""
