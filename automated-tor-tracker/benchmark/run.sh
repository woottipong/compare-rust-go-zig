...
RESULT_FILE="$RESULTS_DIR/automated-tor-tracker_$(date +%Y%m%d_%H%M%S).txt"
...
echo "╔══════════════════════════════════════════╗"
echo "║        Automated TOR Tracker Bench       ║"
echo "╚══════════════════════════════════════════╝"
...
build_image "tor-go" "$PROJECT_DIR/go"
build_image "tor-rust" "$PROJECT_DIR/rust"
build_image "tor-zig" "$PROJECT_DIR/zig"
echo ""
...
run_benchmark "Go" "tor-go"
run_benchmark "Rust" "tor-rust"
run_benchmark "Zig" "tor-zig"
...
echo "── Binary Size ───────────────────────────────"
printf "  Go  : %s\n" "$(get_binary_size tor-go /usr/local/bin/automated-tor-tracker)"
printf "  Rust: %s\n" "$(get_binary_size tor-rust /usr/local/bin/automated-tor-tracker)"
printf "  Zig : %s\n" "$(get_binary_size tor-zig /usr/local/bin/automated-tor-tracker)"
echo ""
